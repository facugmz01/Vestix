...
function SessionModal({ 
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.8)', zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ background: 'var(--bg-base)', padding: '32px', borderRadius: '12px', width: '90%', maxWidth: '400px', boxShadow: '0 10px 30px rgba(0,0,0,0.3)' }}>
      ...
      <style>{`
        ...
        @media (max-width: 900px) {
          ...
          .pos-cart-panel {
            ...
            height: 600px; /* fixed height for mobile cart view */
          }
        }
      `}</style>
      ...
      <div className="pos-container">
        ...
        <div className="pos-cart-panel">
          ...
          <div style={{ padding: '16px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <Button variant="ghost" size="sm" onClick={() => setCustomerFormOpen(true)} title="Nuevo Cliente" style={{ padding: '8px' }}>
              <Plus size={18} />
            </Button>
          </div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '8px' }}>
                      ...
                      <div style={{ textAlign: 'right', display: 'flex', flexDirection: 'column', gap: '4px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', justifyContent: 'flex-end' }}>
                          <span style={{ fontSize: '11px', color: 'var(--text-muted)' }}>Precio</span>
                          <input 
                            type="number" 
                            ...
                            style={{ width: '80px', padding: '4px', textAlign: 'right', border: '1px solid var(--border)', borderRadius: '4px', fontWeight: 700, background: 'var(--bg-base)', fontSize: '13px' }}
                          />
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '4px', justifyContent: 'flex-end' }}>
