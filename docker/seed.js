...
const { DEFAULT_ROLE_PERMISSIONS } = require('./dist/domains/identity/constants/system-roles');
const { ALL_PRESET_LABEL_TEMPLATES } = require('./dist/domains/catalog/labels/label-layout.types');
