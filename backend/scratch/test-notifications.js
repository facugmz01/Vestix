...
async function testNotifications() {
  ...
  // Instantiate services manually for integration testing of production-compiled code
  ...
  if (allSent) {
    console.log('\n✅ VALIDATION SUCCESSFUL: All notification jobs interpolated and dispatched correctly via mock fallbacks!');
  } else {
