...
exports.InvoicingModule = InvoicingModule = __decorate([
    ...
    (0, common_1.Module)({
        ...
        providers: [invoicing_service_1.InvoicingService, afip_service_1.AfipService, afip_producer_1.AfipProducer, afip_processor_1.AfipProcessor],
        exports: [invoicing_service_1.InvoicingService, afip_producer_1.AfipProducer],
    })
], InvoicingModule);
