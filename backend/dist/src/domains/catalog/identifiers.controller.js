...
let IdentifiersController = class IdentifiersController {
    ...
    async generateSku(body) {
        const sku = await this.identifiersService.generateVariantSku(body.productId || 'GENERIC', body.attributes || []);
        return { sku };
    }
...
exports.IdentifiersController = IdentifiersController;
__decorate([
    (0, common_1.Post)('generate-sku'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], IdentifiersController.prototype, "generateSku", null);
__decorate([
    (0, common_1.Post)('generate-barcode'),
    __metadata("design:type", Function),
