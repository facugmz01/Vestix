...
exports.PricingModule = PricingModule = __decorate([
    (0, common_1.Global)(),
    (0, common_1.Module)({
        controllers: [pricing_controller_1.PricingController, promotions_controller_1.PromotionsController],
        providers: [pricing_service_1.PricingService, rules_engine_service_1.RulesEngineService],
        exports: [pricing_service_1.PricingService, rules_engine_service_1.RulesEngineService],
    })
], PricingModule);
