...
let AuditInterceptor = class AuditInterceptor {
    constructor(auditService, auditContextService) {
        ...
        return new rxjs_1.Observable((subscriber) => {
            this.auditContextService.run({ userId, userEmail, ipAddress, requestId }, () => {
                next.handle().pipe((0, rxjs_1.tap)(() => {
                    ...
                    const action = method === 'POST' ? audit_service_1.AuditAction.CREATE
                        : method === 'DELETE' ? audit_service_1.AuditAction.DELETE
                            : audit_service_1.AuditAction.UPDATE;
