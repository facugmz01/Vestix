...
exports.PosModule = PosModule = __decorate([
    (0, common_1.Module)({
        imports: [sales_module_1.SalesModule, prisma_module_1.PrismaModule],
        controllers: [pos_controller_1.PosController, cash_registers_controller_1.CashRegistersController],
