...
export declare class InventoryService {
    ...
    private updateStock;
    reserveStock(variantId: string, warehouseId: string, branchId: string, quantity: number, orderId: string): Promise<{
        id: string;
        variantId: string;
        sourceWarehouseId: string | null;
        destinationWarehouseId: string | null;
    ...
    releaseReservation(variantId: string, warehouseId: string, branchId: string, quantity: number, orderId: string): Promise<{
        id: string;
        variantId: string;
        sourceWarehouseId: string | null;
        destinationWarehouseId: string | null;
