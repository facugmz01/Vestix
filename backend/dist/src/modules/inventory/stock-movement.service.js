...
let StockMovementService = class StockMovementService {
    ...
    async processSaleExit(payload) {
        if (payload.wasReserved) {
            await this.inventoryLedger.releaseReservation(payload.variantId, payload.sourceWarehouseId, payload.branchId, payload.quantity, payload.orderId);
        }
        return this.inventoryLedger.recordMovement({
            variantId: payload.variantId,
    ...
    async processReservation(payload) {
        return this.inventoryLedger.reserveStock(payload.variantId, payload.warehouseId, payload.branchId, payload.quantity, payload.orderId);
    }
};
