...
exports.NotificationsController = exports.SendTestNotificationDto = void 0;
...
let NotificationsController = class NotificationsController {
    ...
    getTemplates(page, pageSize) {
        return {
            data: notification_templates_registry_1.NOTIFICATION_TEMPLATES,
            total: notification_templates_registry_1.NOTIFICATION_TEMPLATES.length,
        };
    }
    getQueue() {
