...
let TransfersService = class TransfersService {
    ...
    async findAll(query) {
        ...
        const variantIds = [...new Set(result.data.flatMap((t) => t.lines.map((l) => l.variantId)))];
        const warehouseIds = [...new Set(result.data.flatMap((t) => [t.sourceWarehouseId, t.destinationWarehouseId]))];
